namespace DataAccess.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataAccess.Context.ECommerceContext>
    {
        ...
        protected override void Seed(DataAccess.Context.ECommerceContext context)
        {
            ...
            {
                new Supplier{ID=Guid.NewGuid(),CompanyName="Özkardeşler",Adress="İstanbul"},
                new Supplier{ID=Guid.NewGuid(),CompanyName="Demir Lojistik",Adress="İstanbul"},
                new Supplier{ID=Guid.NewGuid(),CompanyName="Kuzey Yeli",Adress="İstanbul"},
                new Supplier{ID=Guid.NewGuid(),CompanyName="Ikura ve Chang Kardeşler Tedarik",Adress="İstanbul"},
            };
